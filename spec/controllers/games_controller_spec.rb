...
describe GamesController do
  ...
  let(:valid_attributes) { { "home_team" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved game as @game" do
        ...
        post :create, {:game => { "home_team" => "invalid value" }}, valid_session
        assigns(:game).should be_a_new(Game)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested game" do
        ...
        Game.any_instance.should_receive(:update).with({ "home_team" => "MyString" })
        put :update, {:id => game.to_param, :game => { "home_team" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the game as @game" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Game.any_instance.stub(:save).and_return(false)
        put :update, {:id => game.to_param, :game => { "home_team" => "invalid value" }}, valid_session
        assigns(:game).should eq(game)
      end
